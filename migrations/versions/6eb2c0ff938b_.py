...
Revision ID: 6eb2c0ff938b
Revises: 18f920483ff5
Create Date: 2021-08-23 13:43:43.294666
...
revision = '6eb2c0ff938b'
down_revision = '18f920483ff5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('item_indexes', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['item_indexes'], ['items.item_index'], ),
