...
Revision ID: d5ee0e8ee43d
Revises: 2005e5d13753
Create Date: 2021-08-22 11:16:37.821467
...
revision = 'd5ee0e8ee43d'
down_revision = '2005e5d13753'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['offers_active_id'], ['offers_active.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('item_index')
    )
